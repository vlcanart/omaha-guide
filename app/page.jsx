...
export default function GOPrototype(){
  ...
  const venueHref=(name)=>{const ven=VENUES.find(x=>x.name===name);if(ven&&ven.slug==="henry-doorly-zoo")return"/zoo/";if(ven&&ven.slug==="joslyn-art-museum")return"/joslyn/";if(ven&&ven.slug==="lauritzen-gardens")return"/lauritzen/";return ven?"/venues/"+ven.slug+"/":null;};
