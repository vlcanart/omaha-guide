...
export const WALKS=[
  {
    id:"w1",name:"Old Market Historic Walk",
    ...
    img:u("photo-1558618666-fcd25c85f82e"),
    stops:[
      {name:"Old Market Passageway",desc:"Hidden alley of artist studios, galleries, and Garden of the Zodiac sculpture garden.",icon:"\uD83C\uDFA8",lat:41.2558,lng:-95.9325,img:u("photo-1577720580479-7d839d829c73")},
      {name:"Jackson Street Cobblestones",desc:"Original 1880s Belgian block cobblestones. Best-preserved historic streetscape in Omaha.",icon:"\uD83E\uDDF1",lat:41.2545,lng:-95.9330,img:u("photo-1558618666-fcd25c85f82e")},
      {name:"Ted & Wally's Ice Cream",desc:"Homemade ice cream churned in-house since 1984. Try the cinnamon or Dutch chocolate.",icon:"\uD83C\uDF66",lat:41.2552,lng:-95.9318,img:u("photo-1501443762994-82bd5dace89a")},
      {name:"Homer's Music",desc:"Omaha's legendary independent record store since 1974. Vinyl, CDs, and local music.",icon:"\uD83C\uDFB5",lat:41.2560,lng:-95.9335,img:u("photo-1483412033650-1015ddeb83d1")},
      {name:"The Durham Museum",desc:"Stunning 1931 Art Deco Union Station with vintage train cars and working soda fountain.",icon:"\uD83D\uDE82",lat:41.2553,lng:-95.9310,img:u("photo-1518998053901-5348d3961a04")},
    ],
  ...
  },
  {
    ...
    img:u("photo-1572947650440-e8a97ef053b2"),
    stops:[
      {name:"The Waiting Room",desc:"Legendary 400-cap indie venue. The heart of Omaha's alt/indie touring scene since 2007.",icon:"\uD83C\uDFB8",lat:41.2810,lng:-95.9540,img:u("photo-1511671782779-c97d3d27a1d4")},
      {name:"Reverb Lounge",desc:"Sleek mid-century modern 150-cap listening room with outstanding sound quality.",icon:"\uD83C\uDFA4",lat:41.2808,lng:-95.9545,img:u("photo-1508854710579-5cecc3a9ff17")},
      {name:"Almost Music",desc:"Beloved record store with deep vinyl selection, local releases, and knowledgeable staff.",icon:"\uD83D\uDCBF",lat:41.2812,lng:-95.9538,img:u("photo-1483412033650-1015ddeb83d1")},
      {name:"Benson Murals",desc:"Vibrant street art on nearly every block. New pieces appear regularly from local and touring artists.",icon:"\uD83C\uDFA8",lat:41.2815,lng:-95.9530,img:u("photo-1572947650440-e8a97ef053b2")},
      {name:"Beercade",desc:"Retro arcade bar with 40+ classic games, craft beer, and free play. A Benson institution.",icon:"\uD83C\uDFAE",lat:41.2808,lng:-95.9535,img:u("photo-1511882150382-421056c89033")},
    ],
  ...
  {
    id:"w3",name:"Blackstone to Dundee",
    ...
    stops:[
      {name:"Blackstone District",desc:"Omaha's cocktail district. James Beard nominees, craft cocktail bars, and rooftop patios.",icon:"\uD83C\uDF78",lat:41.2590,lng:-95.9650,img:u("photo-1414235077428-338989a2e8c0")},
      {name:"Crescent Moon",desc:"Omaha's best beer bar with 60+ taps and the legendary Reuben sandwich.",icon:"\uD83C\uDF1D",lat:41.2592,lng:-95.9670,img:u("photo-1514933651103-005eec06c04b")},
      {name:"Dundee Memorial Park",desc:"Beautiful green space perfect for a mid-walk rest. Mature trees and walking paths.",icon:"\uD83C\uDF33",lat:41.2610,lng:-95.9750,img:u("photo-1441974231531-c6227db76b6e")},
      {name:"Pitch Pizzeria",desc:"Coal-fired Neapolitan pizza in a converted Dundee gas station. James Beard semifinalist.",icon:"\uD83C\uDF55",lat:41.2620,lng:-95.9800,img:u("photo-1513104890138-7c749659a591")},
      {name:"Dundee Merchants",desc:"Charming stretch of Underwood Ave with boutiques, coffee shops, and the beloved eCreamery.",icon:"\uD83D\uDED2",lat:41.2625,lng:-95.9810,img:u("photo-1441986300917-64674bd600d8")},
    ],
  ...
  },
  {
    ...
    img:u("photo-1579783902614-a3fb3927b6a5"),
    stops:[
      {name:"Love's Jazz & Arts Center",desc:"Community arts center honoring Omaha's deep jazz heritage. Named for Preston Love Sr.",icon:"\uD83C\uDFB7",lat:41.2800,lng:-95.9400,img:u("photo-1415201364774-f6f0bb35f28f")},
      {name:"24th & Lake Murals",desc:"Large-scale murals depicting jazz musicians, civil rights leaders, and community stories.",icon:"\uD83C\uDFA8",lat:41.2805,lng:-95.9405,img:u("photo-1579783902614-a3fb3927b6a5")},
      {name:"The Union for Contemporary Art",desc:"Community-powered arts center with exhibitions, co-op studios, and artist fellowships.",icon:"\uD83D\uDD8C\uFE0F",lat:41.2810,lng:-95.9410,img:u("photo-1541961017774-22349e4a1262")},
      {name:"Historic Dreamland Ballroom Site",desc:"Where Duke Ellington, Count Basie, and Nat King Cole performed in the 1930s-50s.",icon:"\uD83C\uDFB6",lat:41.2815,lng:-95.9395,img:u("photo-1493225457124-a3eb161ffa5f")},
      {name:"Malcolm X Birth Site",desc:"Historical marker at 3448 Pinkney St where Malcolm X was born in 1925.",icon:"\u2B50",lat:41.2830,lng:-95.9420,img:u("photo-1506905925346-21bda4d32df4")},
    ],
  ...
  },
  {
    ...
    img:u("photo-1506157786151-b8491531f063"),
    stops:[
      {name:"Gene Leahy Mall",desc:"The crown jewel \u2014 $290M urban park with splash pad, slides, amphitheater, and Kiewit Luminarium.",icon:"\uD83C\uDFDE\uFE0F",lat:41.2580,lng:-95.9280,img:u("photo-1503676260728-1c00da094a0b")},
      {name:"The Luminarium",desc:"82,000 sq ft interactive science center right on the mall. 125+ hands-on exhibits.",icon:"\uD83D\uDD2C",lat:41.2565,lng:-95.9230,img:u("photo-1503676260728-1c00da094a0b")},
      {name:"Heartland of America Park",desc:"8-acre park with a large lake, lighted fountain, and walking paths.",icon:"\u26F2",lat:41.2555,lng:-95.9250,img:u("photo-1506157786151-b8491531f063")},
      {name:"Lewis & Clark Landing",desc:"Riverfront plaza with Missouri River overlook, public art, and seasonal events.",icon:"\u2693",lat:41.2575,lng:-95.9215,img:u("photo-1506157786151-b8491531f063")},
      {name:"Bob Kerrey Pedestrian Bridge",desc:"3,000-foot bridge crossing the Missouri to Iowa. Best sunset views in Omaha.",icon:"\uD83C\uDF05",lat:41.2575,lng:-95.9210,img:u("photo-1506157786151-b8491531f063")},
    ],
